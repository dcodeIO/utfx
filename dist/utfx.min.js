...
e.codePointAt=function(b,a){var c;e.UTF16toUTF8(function(){return"undefined"===typeof c&&a<b.length?b.charCodeAt(a++):null},function(a){c=a});return c};e.polyfill=function(b){if(!f.fromCodePoint||b)f.fromCodePoint=e.fromCodePoint;if(!f.prototype.codePointAt||b)f.prototype.codePointAt=function(a){return e.codePointAt(this,a)};return e};"object"===typeof module&&module&&module.exports?module.exports=e:"function"===typeof define&&define.amd?define(e):(h.dcodeIO||(h.dcodeIO={}),h.dcodeIO.utfx=e)})(this,
String);
