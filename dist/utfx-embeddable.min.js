var utfx=function(){function l(){return null}function g(){}function h(a){return 128>a?1:2048>a?2:65536>a?3:4}function m(a){if("number"!==typeof a||a!==a)throw TypeError("Illegal code point: "+a);if(0>a||1114111<a)throw RangeError("Illegal code point: "+a);}var f={TruncatedError:function(a){if(!(this instanceof f.TruncatedError))return new f.TruncatedError(a);Error.call(this);this.name="TruncatedError";this.message=a.join(", ");this.bytes=a}};f.TruncatedError.prototype=Error();f.encodeUTF8=function(a,
d,c){var b=null;"number"===typeof a&&(b=a,a=l);if(c)c=g;else{if("function"!==typeof a||"function"!==typeof d)throw TypeError("Illegal arguments: "+typeof a+", "+typeof d);c=function(a){if(0>a||1114111<a)throw RangeError("Illegal code point: "+a);}}for(;null!==b||null!==(b=a());)c(b),128>b?d(b&127):(2048>b?d(b>>6&31|192):(65536>b?d(b>>12&15|224):(d(b>>18&7|240),d(b>>12&63|128)),d(b>>6&63|128)),d(b&63|128)),b=null};f.decodeUTF8=function(a,d,c){if(!c&&("function"!==typeof a||"function"!==typeof d))throw TypeError("Illegal arguments: "+
...
0,b=0;f.UTF16toUTF8(a,function(a){++c;b+=h(a)},d);return[c,b]};return f}();
